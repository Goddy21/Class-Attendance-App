...
public class LecturerDashboard extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lecturer_dashboard2);
        ...
        lvNewDevices.setOnItemClickListener(LecturerDashboard.this);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
            ...
            mBluetoothConnection = new BluetoothConnectionService(LecturerDashboard.this);
        }
    }
}